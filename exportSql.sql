...
--
-- Host: localhost    Database: newdata
-- ------------------------------------------------------
...
-- Dump completed on 2024-01-01 15:41:49
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
...
CREATE TABLE `human` (
  ...
  `humanName` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`humanid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: localhost    Database: lektion2
-- ------------------------------------------------------
-- Server version	8.0.35
...
--
-- Table structure for table `atempted_purchase`
--

DROP TABLE IF EXISTS `atempted_purchase`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `atempted_purchase` (
  `money` int DEFAULT NULL,
  `price` int DEFAULT NULL,
  `want` tinyint(1) DEFAULT NULL,
  `father_purchase` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `atempted_purchase`
--

LOCK TABLES `atempted_purchase` WRITE;
/*!40000 ALTER TABLE `atempted_purchase` DISABLE KEYS */;
/*!40000 ALTER TABLE `atempted_purchase` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `calculator` (
  ...
  `sum_result` decimal(10,2) GENERATED ALWAYS AS ((`number1` + `number2`)) VIRTUAL,
  `difference_result` decimal(10,2) GENERATED ALWAYS AS ((`number1` - `number2`)) VIRTUAL,
  `product_result` decimal(10,2) GENERATED ALWAYS AS ((`number1` * `number2`)) VIRTUAL,
  `quotient_result` decimal(10,2) GENERATED ALWAYS AS ((`number1` / nullif(`number2`,0))) VIRTUAL,
  PRIMARY KEY (`id`)
